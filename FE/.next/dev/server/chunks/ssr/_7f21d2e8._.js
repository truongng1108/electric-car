...
function AdminReviewsPage() {
    ...
    const fetchReviews = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$7_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async ()=>{
        try {
            setIsLoading(true);
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["reviewsApi"].getAll();
            setReviews(response.reviews);
            const productIds = [
                ...new Set(response.reviews.map((review)=>{
                    return typeof review.product === "string" ? review.product : review.product._id;
                }))
            ];
            const productPromises = productIds.map(async (id)=>{
                try {
                    const productResponse = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["productsApi"].getById(id);
                    return {
                        id,
    ...
    const handleDelete = async ()=>{
        if (selectedReview) {
            try {
                await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["reviewsApi"].delete(selectedReview._id);
                toast({
...
//# sourceMappingURL=_7f21d2e8._.js.map